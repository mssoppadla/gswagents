...
print(f"[DEBUG]: Tenants router is {tenants.router}")
print(f"[DEBUG]: Guest router is {guest.router}")
print(f"[DEBUG]: Chat router is {chat.router}")
print(f"[DEBUG]: Knowledge router is {knowledge.router}")

# Health check
@app.get("/healthz", tags=["ops"])
async def healthz():
    return {"status": "ok" if getattr(app.state, "agent", None) else "initializing"}
